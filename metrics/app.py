...
def main():
    ...
    models = [
        Model(name='MPG: Multi-ingredient Pizza Generator', ckpt_path=f'{ROOT}/mpg/runs/2y8walj3/010000.pt'),
        ...
        Model(name='MPG-mapping', ckpt_path=f'{ROOT}/mpg/runs/3ae90gw9/010000.pt'),
        Model(name='MPG-SLE', ckpt_path=f'{ROOT}/mpg/runs/c1ysmsbe/010000.pt'),
        Model(name='MPG-SLE*', ckpt_path=f'{ROOT}/mpg/runs/306bmus9/010000.pt'),
        Model(name='MPG-CR', ckpt_path=f'{ROOT}/mpg/runs/1zg4fv6o/010000.pt'),
        Model(name='MPG-matching', ckpt_path=f'{ROOT}/mpg/runs/2ftkg1ww/010000.pt'),
        Model(name='MPG-uncond', ckpt_path=f'{ROOT}/mpg/runs/1s8jphpa/000000.pt'),
    ]
